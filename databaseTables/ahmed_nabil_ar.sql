...
--
ALTER TABLE `blog`
  ADD CONSTRAINT `blog_id_ar` FOREIGN KEY (`blog_id`) REFERENCES `ahmed_nabil`.`blog` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `team`
  ADD CONSTRAINT `member_ar_id` FOREIGN KEY (`member_id`) REFERENCES `ahmed_nabil`.`team` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
