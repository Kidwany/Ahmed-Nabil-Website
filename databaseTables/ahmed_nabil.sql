...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 18, 2019 at 06:34 PM
...
(6, NULL, NULL, 2, '2019-06-25 12:57:58', '2019-06-25 12:57:58');
...
(3, 'Kidwany', 'admin@ahmed-nabil.com', NULL, NULL, NULL, '$2y$10$hK.eiBbbNJsfhenhnuiyBeyFG3YKJgspnP0uUsvFM33SXqZ2OPLd6', 'WQv2Xm4idqnOLvFgdd60kX4xI3iyMmaB6qUw9cJsB3CeEf520JbbDXERilYf', '2019-08-14 09:42:26', '2019-08-14 09:42:26');
...
ALTER TABLE `album`
  ...
  ADD CONSTRAINT `album_image_id` FOREIGN KEY (`image_id`) REFERENCES `image` (`id`);

--
-- Constraints for table `appointment`
--
ALTER TABLE `appointment`
  ADD CONSTRAINT `appointment_file_id` FOREIGN KEY (`file_id`) REFERENCES `file` (`id`),
  ADD CONSTRAINT `appointment_service_id` FOREIGN KEY (`service_id`) REFERENCES `service` (`id`);

--
-- Constraints for table `blog`
--
ALTER TABLE `blog`
  ADD CONSTRAINT `blog_created_by` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `blog_image_id` FOREIGN KEY (`image_id`) REFERENCES `image` (`id`);
...
--
ALTER TABLE `team`
  ADD CONSTRAINT `service_id` FOREIGN KEY (`service_id`) REFERENCES `service` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `team_created_by` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `team_image_id` FOREIGN KEY (`image_id`) REFERENCES `image` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `video`
  ADD CONSTRAINT `video_album_id` FOREIGN KEY (`album_id`) REFERENCES `album` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `video_created_by` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
